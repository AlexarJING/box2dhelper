---box2d lib debugdraw
love.window.setTitle("box2d helper lib demo")

-------------world----------------------

local body = love.physics.newBody(world, 0, 0, "static")
local shape = love.physics.newChainShape(false, 10,10,10, 750,1000,750,1000,10)
...
---_G.joint = love.physics.newMouseJoint(body, 0, 0)
--pause=true
